...
NetworkResponse _$NetworkResponseFromJson(Map<String, dynamic> json) {
  switch (json['runtimeType']) {
    ...
    default:
      throw CheckedFromJsonException(json, 'runtimeType', 'NetworkResponse',
...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl(final Map<String, dynamic> data, {final String? $type})
      : _data = data,
        $type = $type ?? 'success';
...
abstract class _Success implements NetworkResponse {
...
abstract class _Error implements NetworkResponse {
...
class _$LoadingImpl implements _Loading {
  const _$LoadingImpl([this.message, final String? $type])
      : $type = $type ?? 'loading';
...
abstract class _Loading implements NetworkResponse {
