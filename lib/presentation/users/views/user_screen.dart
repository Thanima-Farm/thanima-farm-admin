             ...
             Column(
              children: [
                Padding(
                  ...
                  borderRadius: BorderRadius.circular(5), // Curved borders
                                ),
                              ),
        ...
        border: Border.all(
          ...
          color: Color(0xFFB4B4B4)
                ...
                child: Row(
                  ...
                  children: [
                    Text("Active",style: TextStyle(color: Color(0xFF757575),fontSize: 10),),
        ...
        border: Border.all(
          ...
          color: Color(0xFFB4B4B4)
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceAround,
                  children: [
                    Text("Disable",style: TextStyle(color: Color(0xFF757575),fontSize: 10),),
                    Icon(Icons.keyboard_arrow_down_rounded,size: 10,)
                  ],
                ),),),
              DataCell(Row(
